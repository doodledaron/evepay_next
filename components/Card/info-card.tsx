        ...
        <div className="mt-8 w-full h-72 rounded-2xl overflow-hidden border-gray-300" style={{ boxShadow: '0 4px 6px rgba(0, 0, 0, 0.3)' }}>
            <div className="px-4 py-5">
                <div className='flex flex-row items-center justify-between bg-lg-light-cyan rounded-full px-4 py-3'>
                    ...
                    <div className='text-white text-base font-bold'>Total EVEC</div>
                </div>
                <div className="py-8">
                    <div className="flex justify-between text-gray-700 text-base">
                        ...
                        <div className="text-base font-semibold text-gray"> Total * 1.25</div>
                    </div>
                    <div className="flex justify-between text-gray-700 text-base mt-4">
                        ...
                        <div className="text-base font-semibold text-gray">Total</div>
                    </div>
                </div>
                ...
                <div className="pt-3">
                    <div className="flex justify-between">
                        ...
                        <div className='text-xs font-semibold text-light-blacK'>RM1 = 1 EVEC</div>
                    </div>
                </div>
            </div>
        </div>
